package genealogytree.client.desktop.configuration;

import genealogytree.client.desktop.configuration.enums.FXMLFile;
import genealogytree.client.desktop.configuration.helper.BorderPaneReloadHelper;
import genealogytree.client.desktop.configuration.messages.AppTitles;
import genealogytree.client.desktop.controllers.FXMLDialogController;
import genealogytree.client.desktop.controllers.FXMLPane;
import genealogytree.client.desktop.controllers.FXMLTab;
import genealogytree.client.desktop.controllers.implementation.scene.*;
