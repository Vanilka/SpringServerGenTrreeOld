...
public class GenTreeDrawingServiceImpl implements GenTreeDrawingService {
    ...
    public void populatePanel(GTPanelChild panel) {
        ...
        //System.out.println("populatePanel panel :" +panel);
        ObservableList<GTX_Relation> relationList = context.getService().getCurrentFamily().getGtx_relations()
      ...
      //  System.out.println("populatePanel relation list :" +relationList);
        ...
        for ( GTX_Relation r : relationList) {
            ...
            //    System.out.println("populatePanel relation list elelemnt add" +child);
