 ...
 * @author mszymkow
 */
public class RegisterFormController implements Initializable, FXMLController {
    private static final Logger LOG = LogManager.getLogger(RegisterFormController.class);
    ...
    private void submitRegister() {
        ...
        if (result instanceof UserResponse) {
            RegisterConfirmationController confirmationController = (RegisterConfirmationController) this.manager
                    .loadFxml(new RegisterConfirmationController(), this.logonWindow.getRegisterForm(),
