 ...
 * @author vanilka
 */
public class LogonWindowController implements Initializable, FXMLController {

	private static final Logger LOG = LogManager.getLogger(LogonWindowController.class);

	private ScreenManager manager;
	private LogonFormController logonFormImpl;
	private RegisterFormController registerFormImpl;
	...
	public void loadRegisterForm() {
		this.registerFormImpl = (RegisterFormController) this.manager.loadFxml(this.registerFormImpl, this.registerForm,
	...
	public void setManager(ScreenManager manager) {
		...
		this.logonFormImpl = (LogonFormController) this.manager.loadFxml(this.logonFormImpl, this.logonForm,
				FXMLFiles.LOGON_FORM.toString());
		this.logonFormImpl.setLogonWindow(this);
	}
	
	public void setCretentials(String login, String pass) {
		this.logonFormImpl.setCrenetrials(login, pass);
	}
