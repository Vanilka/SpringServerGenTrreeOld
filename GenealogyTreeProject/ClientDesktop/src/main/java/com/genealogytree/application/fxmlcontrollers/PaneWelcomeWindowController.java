 ...
 * @author vanilka
 */
public class PaneWelcomeWindowController implements Initializable, FXMLPaneController {
    ...
    public void chooseProject(MouseEvent event) {
        if (event.getClickCount() == 2 && projectsList.getSelectionModel().getSelectedItem() != null) {
                ...
                this.context.getFamilyService().setCurrentFamily(projectsList.getSelectionModel().getSelectedItem());
