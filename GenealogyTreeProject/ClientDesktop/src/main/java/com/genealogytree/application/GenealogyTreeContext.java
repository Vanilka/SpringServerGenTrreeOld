...
public class GenealogyTreeContext {
	...
	private ObjectProperty<User> connectedUser = new SimpleObjectProperty<>();
	...
	public GTUserService getUserService() {
		if (this.userService == null) {
			this.userService = new GTUserService();
			this.userService.setContext(this);
		}
		return userService;
	}
	...
	public GTFamillyService getFamilyService() {
		if (this.familyService == null) {
			this.familyService = new GTFamillyService();
		}
