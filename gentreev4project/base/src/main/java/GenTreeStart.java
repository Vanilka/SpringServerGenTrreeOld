import gentree.v4.base.managers.ScreenManagerImpl;
...
public class GenTreeStart {
    ...
    private static ScreenManager sm = ScreenManagerImpl.INSTANCE;
    ...
    public static void main(String[] args) {
        ...
        counter.removeListener(weakListener);
...
/*        changeListener = new ChangeListener<Number>() {
          ...
          changeListener = GenTreeStart::changed;
